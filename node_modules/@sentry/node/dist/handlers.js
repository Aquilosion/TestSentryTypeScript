...
function parseRequest(event, req) {
    var preparedEvent = __assign({}, event, { extra: __assign({}, event.extra, { node: global.process.version }), modules: getModules(), request: __assign({}, event.request, extractRequestData(req)), server_name: global.process.env.SENTRY_NAME || os_1.hostname() });
    if (req.user) {
